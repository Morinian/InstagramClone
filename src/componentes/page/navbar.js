    ...
    <div className={Styles.linha}>
        <header>
            ...
            <div className={Styles.links}>
                <button className={Styles.pagina} href="#">
                ...
                <button href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-camera-reels"
                        viewBox="0 0 16 16">
                ...
                <button className={Styles.perfil} href="#">
                    <img src={perfil}/>
                    Perfil
                </button>
            </div>

            <button href="#" className={Styles.mais}>
        ...
        <section className={Styles.ocupar}></section>
    </div>
  );
}
